...
Сначала выполняется поиск релевантной информации в FAQ. Если подходящий ответ
не найден, система обращается к дополнительным документам. При отсутствии
релевантной информации пользователь получает рекомендацию обратиться
к сотруднику отеля.
...
graph TD
    ...
    E -->|Нет| G["К сожалению, у меня нет информации по этому вопросу.<br><br>Пожалуйста, обратитесь к сотруднику отеля."]
```
---
