...
Для обработки пользовательских вопросов по базе знаний используется RAG-подход.
Сначала выполняется поиск релевантной информации в FAQ. Если информация не найдена, бот сообщает об этом пользователю и предлагает переформулировать вопрос или уточнить детали.

```mermaid
graph TD
    A["Вопрос пользователя"] --> B{"Найден FAQ?"}
    ...
    E -->|Нет| G["Извините, я не смог найти информацию по вашему вопросу.<br><br> Попробуйте переформулировать его или уточнить детали."]
```
---
...
<img width="1365" height="911" alt="localhost-admin-support-document" src="https://github.com/user-attachments/assets/2a85acca-6854-4b3b-960c-2bde77c0128b" /><br />
...
| `langchain-community` |Загрузка и обработка PDF-документов|
| `pypdf` |Извлечение текста из PDF-документов|
